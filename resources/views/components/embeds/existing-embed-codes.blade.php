                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex space-x-2">
                                <button 
                                    ...
                                    x-on:click="showModal = true; id = {{ $embedCode->id }}; title = '{{ $embedCode->title }}'; content = '{{ $embedCode->content }}'; link = '{{ route('embed.update', $embedCode->id) }}'"
                                    >
                                    Edit
                                </button>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 w-full max-w-lg">
            ...
            <form method="POST" x-bind:action="link">
                ...
                <div class="mb-4">
                    ...
                    <x-textarea name="content" id="content" x-model="content" class="w-full"></x-textarea>
                </div>
