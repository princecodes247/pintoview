    ...
    <div class="relative w-full flex flex-col">
      ...
      <nav class="relative items-center pt-5 px-4 mx-auto w-full sm:px-8 lg:flex md:space-x-6">
        ...
        <ul
          class="flex-1 justify-between mt-12 md:text-sm md:font-medium md:flex md:mt-0 absolute inset-x-0 px-4 border-b bg-white md:border-none md:static"
        ...
        >
          ...
          <li class="order-2 py-5 md:py-0">
            <button class="inline-flex h-12 items-center justify-center font-geist rounded-md border border-gray-800 bg-gradient-to-t from-[#8678f9] from-0% to-[#c7d2fe] px-6 font-medium text-gray-950 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50 ">
              Get Started
            </button>
          </li>
        </ul>
      </nav>
      <section class="py-28 z-10">
        <div class="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
          <div class="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
            <h1 class="text-sm  text-gray-400 group font-geist mr-auto px-5 py-2 bg-gradient-to-tr from-zinc-300/5 via-gray-400/5 to-transparent  border-[2px] border-white/5 rounded-3xl w-fit">
              Over 200+ deals finished
              <ChevronRight class="inline w-4 h-4 ml-2 group-hover:translate-x-1 duration-300" />
            </h1>
            <h2 class="text-4xl md:text-5xl font-geist font-normal tracking-tighter lg:text-5xl text-transparent bg-clip-text bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]">
        ...
        <div class="mt-14 px-4 md:px-8">
          <p class="text-center font-displayAlt text-sm text-gray-700 font-semibold">
