<div class="relative flex flex-col w-[90%] mx-auto mt-10 rounded-lg">
    {{-- <img class="absolute z-0 -translate-y-1/3 top-10" src="https://farmui.vercel.app/bg-back.png" width={1000}
        height={1000} alt="back bg" /> --}}

    {{-- <div class="absolute -z-1 inset-0  h-[600px] w-full bg-transparent opacity-10 bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]"></div> --}}
    ...
    {{-- <nav class="relative items-center w-full px-4 pt-5 mx-auto sm:px-8 lg:flex md:space-x-6">
        <div class="flex justify-between">
            <a href="javascript:void(0)">
                <img src="https://www.farmui.com/logo.svg" width="120" height="50" alt="FarmUI logo" />
            </a>
            <button class="text-gray-500 outline-none md:hidden">
        ...
        <ul
            class="absolute inset-x-0 justify-between flex-1 px-4 mt-12 bg-white border-b md:text-sm md:font-medium md:flex md:mt-0 md:border-none md:static">
            ...
            <li class="order-2 py-5 md:py-0">
                <button
                    class="inline-flex h-12 items-center justify-center font-geist rounded-md border border-gray-800 bg-gradient-to-t from-[#8678f9] from-0% to-[#c7d2fe] px-6 font-medium text-gray-950 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50 ">
                    Get Started
                </button>
            </li>
        </ul>
    </nav> --}}
    <section class="z-10 py-28">
        <div
            class="items-center justify-between max-w-screen-xl mx-auto overflow-hidden text-gray-600 gap-x-12 md:flex md:px-8">
            <div class="flex-none px-4 space-y-5 sm:max-w-lg md:px-0 lg:max-w-xl">
                <h1
                    class="text-sm  text-gray-500 group font-geist mr-auto px-5 py-2 bg-gradient-to-tr from-zinc-300/5 via-gray-400/5 to-transparent  border-[3px] border-white/25 rounded-3xl w-fit">
                    Over 200+ deals finished
                    <ChevronRight class="inline w-4 h-4 ml-2 duration-300 group-hover:translate-x-1" />
                </h1>
                <h2
                    class="text-4xl md:text-5xl font-geist font-bold tracking-tighter lg:text-5xl bg-clip-text bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]">
                    We help startups to grow and make money
                </h2>
                <p class="font-geist">
                    Empowering you to turn every idea into an opportunity, From blog posts to videos—share it all and
                    monetize your reach.
                </p>
                {{-- <div class="items-center space-y-3 gap-x-3 sm:flex sm:space-y-0">
                    <button
                        class="inline-flex h-12 items-center justify-center font-geist rounded-md border border-gray-800 bg-gradient-to-t from-[#8678f9] from-0% to-[#c7d2fe] px-6 font-medium text-gray-950 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50 ">
                        Get Started
        ...
        {{-- <div class="px-4 mt-14 md:px-8">
            <p class="text-sm font-semibold text-center text-gray-700 font-displayAlt">
                Trusted by the best companies
            </p>
            <div class="flex flex-wrap items-center justify-center mt-6 gap-x-12 gap-y-6">
